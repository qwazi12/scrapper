...
- **Anti-ban pacing:** yt-dlp `-t sleep` preset is ON by default (`YTDLP_SLEEP_PRESET`) — 0.75s between requests + randomized 10–20s between downloads. Costs ~40s/clip; this is the main thing keeping a headless server off YouTube/TikTok ban radar.
